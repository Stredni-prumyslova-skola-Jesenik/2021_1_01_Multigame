...
TLOUSTKA_PALKY = 10
DELKA_PALKY = 100
RYCHLOST = 500  # v pixelech za sekundu
...
def nakresli_obdelnik(x1, y1, x2, y2):
    ...
    Nazorny diagram::
         ...
         y2 vyska
    """
    obdelnik=shapes.Rectangle(x1, y1, x2, y2, color=(255, 255, 255))
    obdelnik.draw()
...
def vykresli():
    ...
    for x, y in [(0, pozice_palek[0]), (SIRKA-TLOUSTKA_PALKY, pozice_palek[1])] :
        nakresli_obdelnik(
            x,
            y - DELKA_PALKY//2,
            TLOUSTKA_PALKY,
